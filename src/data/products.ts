...
export const products: Product[] = [
  {
    ...
    category: "copper",
    description:
      "High-grade copper concentrate from our flagship Highland Valley operation, suitable for smelting and refining.",
    detailedDescription:
      "Our copper concentrate is produced through advanced flotation processes, ensuring consistent quality and high copper content. Sourced from our world-class Highland Valley operation, this product meets international standards for smelter feed.",
    specifications: [
  ...
  },
  {
    ...
    category: "gold",
    description:
      "Semi-pure alloy of gold and silver produced at our Australian operations, ready for final refining.",
    detailedDescription:
      "Gold doré bars are produced through our state-of-the-art processing facilities at Golden Ridge Mine. Each bar is individually numbered and assayed, with certificates provided for gold and silver content.",
    specifications: [
  ...
  },
  {
    ...
    category: "graphite",
    description:
      "High-quality natural flake graphite suitable for batteries, lubricants, and refractory applications.",
    detailedDescription:
      "Our flake graphite is carefully processed to preserve crystal structure and maximize carbon content. Available in multiple size grades to meet diverse industrial requirements.",
    specifications: [
  ...
  },
  {
    ...
    category: "rare-earth",
    description:
      "Mixed rare earth oxide concentrate containing neodymium, praseodymium, and dysprosium.",
    detailedDescription:
      "Extracted from our Inner Mongolia operation, this rare earth concentrate contains critical elements essential for permanent magnets, renewable energy technologies, and advanced electronics.",
    specifications: [
  ...
  },
  {
    ...
    category: "silver",
    description:
      "High-purity silver bullion bars produced as a byproduct of our gold and copper operations.",
    detailedDescription:
      "Our silver bullion meets international standards for purity and quality. Each bar is stamped with weight, purity, and serial number, with full certification provided.",
    specifications: [
  ...
  },
  {
    ...
    category: "other",
    description:
      "High-grade molybdenum concentrate recovered as a byproduct from copper operations.",
    detailedDescription:
      "Molybdenum concentrate produced through selective flotation at our Highland Valley operation. Suitable for ferromolybdenum production and chemical processing.",
    specifications: [
  ...
  },
  {
    ...
    category: "other",
    description:
      "Battery-grade lithium carbonate from our Andean brine operation.",
    detailedDescription:
      "High-purity lithium carbonate produced through solar evaporation and chemical processing of lithium-rich brines. Specifically processed to meet the stringent requirements of lithium-ion battery manufacturers.",
    specifications: [
  ...
  },
  {
    ...
    category: "other",
    description:
      "High-quality zinc concentrate from our Silverstone operation.",
    detailedDescription:
      "Zinc concentrate produced through selective flotation, delivering consistent quality for zinc smelters worldwide.",
    specifications: [
